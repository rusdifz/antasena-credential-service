...
function makeInternalCreateRoleDetail({ roleDb, makeRole, userDb, makeNotification }) {
    return function internalCreateRoleDetail(body) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validasiRole = yield makeRole(body);
                const data = yield roleDb.createDataRoleDetail(validasiRole);
                ...
                throw new Error('usecase-makeInternalCreateRoleDetail' + error);
            }
        });
    };
}
