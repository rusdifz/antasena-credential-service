...
function makeInternalUpdateRoleMapping({ internalUpdateDataRoleMapping }) {
    return function internalUpdateRoleMapping(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const bodyparam = httpRequest.body;
                console.log('controller', bodyparam);
                const posted = yield internalUpdateDataRoleMapping(bodyparam);
                return {
                    headers: {
