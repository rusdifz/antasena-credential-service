...
function makeValidasiRoleDelete({ validasiDataRoleDelete, internalServer }) {
    return function validasiRoleDelete(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield validasiDataRoleDelete(bodyparam);
                }
                return {
                    headers: {
...
exports.default = makeValidasiRoleDelete;
