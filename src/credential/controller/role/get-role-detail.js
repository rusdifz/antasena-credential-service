...
function makeGetRoleDetail({ getDataRoleDetail, internalServer, redisClient }) {
    return function getRoleDetail(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield getDataRoleDetail(bodyparam);
                }
                const entityLog = {
                    ...
                    actionType: 'get',
                    actionDetail: 'Show List Data Role Detail',
