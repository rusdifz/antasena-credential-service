...
function makeCreateRoleDetail({ createDataRoleDetail, internalServer, redisClient }) {
    return function createRoleDetail(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield createDataRoleDetail(bodyparam);
                    const entityLog = {
                        ...
                        actionType: 'Create',
                        actionDetail: 'Create New Role',
                        actionBeUrl: '/credential/role/detail',
                        actionBeMethod: 'PUT'
                    };
