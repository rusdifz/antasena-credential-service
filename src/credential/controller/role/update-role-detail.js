...
function makeUpdateRoleDetail({ updateDataRoleDetail, internalServer, redisClient }) {
    return function updateRoleDetail(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield updateDataRoleDetail(bodyparam);
                    const entityLog = {
