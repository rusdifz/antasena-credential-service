...
function makeDeleteRoleDetail({ deleteDataRoleDetail, internalServer, redisClient }) {
    return function deleteRoleDetail(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield deleteDataRoleDetail(bodyparam);
                    const entityLog = {
