...
function makeUpdateRoleMapping({ updateDataRoleMapping, internalServer, redisClient }) {
    return function updateRoleMapping(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield updateDataRoleMapping(bodyparam);
                    const entityLog = {
                        ...
                        actionType: 'Update',
                        actionDetail: 'Update Role Mapping',
                        actionBeUrl: '/credential/role/mapping',
                        actionBeMethod: 'POST'
                    };
