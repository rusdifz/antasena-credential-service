...
function makeGetBranch({ getDataBranch, internalServer, redisClient }) {
    return function getBranch(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield getDataBranch(bodyparam);
                }
                const entityLog = {
                    ...
                    actionType: 'get',
                    actionDetail: 'Show List Data Branch All',
                    actionBeUrl: '/credential/branch',
                    actionBeMethod: 'GET'
                };
