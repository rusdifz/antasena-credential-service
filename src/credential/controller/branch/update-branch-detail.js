...
function makeUpdateBranchDetail({ updateDataBranchDetail, internalServer, redisClient }) {
    return function updateBranchDetail(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield updateDataBranchDetail(bodyparam);
                    const entityLog = {
