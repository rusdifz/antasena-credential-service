...
function makeCreateBranchDetail({ createDataBranchDetail, internalServer, redisClient }) {
    return function createBranchDetail(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield createDataBranchDetail(bodyparam);
                    const entityLog = {
                        ...
                        actionType: 'create',
                        actionDetail: 'Create New Branch',
                        actionBeUrl: '/credential/branch/detail',
                        actionBeMethod: 'PUT'
                    };
                ...
                // entityLog.username = ''
                // entityLog.moduleId = httpRequest.body.moduleId 
                // entityLog.actionStatus = 'failed'
