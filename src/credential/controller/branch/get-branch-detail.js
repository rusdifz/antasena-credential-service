...
function makeGetBranchDetail({ getDataBranchDetail, internalServer, redisClient }) {
    return function getBranchDetail(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield getDataBranchDetail(bodyparam);
                }
                const entityLog = {
                    ...
                    actionType: 'get',
                    actionDetail: 'Show List Data Branch Detail',
