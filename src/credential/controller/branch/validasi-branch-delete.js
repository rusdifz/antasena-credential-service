...
function makeValidasiBranchDelete({ validasiDataBranchDelete, internalServer }) {
    return function validasiBranchDelete(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield validasiDataBranchDelete(bodyparam);
                }
                return {
                    headers: {
