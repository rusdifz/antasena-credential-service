...
function makeValidasiBranchInput({ validasiDataBranchInput, internalServer }) {
    return function validasiBranchInput(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield validasiDataBranchInput(bodyparam);
                }
                return {
                    headers: {
