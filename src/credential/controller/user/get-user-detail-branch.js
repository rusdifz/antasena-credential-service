...
function makeGetUserDetailBranch({ getDataUserDetailBranch, internalServer, redisClient }) {
    return function getUserDetailBranch(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield getDataUserDetailBranch(bodyparam);
                }
                const entityLog = {
                    username: authMe.data.username,
                    moduleId: bodyparam.moduleId,
                    // menuId: '003',
                    screenId: 'Master User',
                    actionType: 'get',
                    actionDetail: 'Show List Data User Branch Detail',
