...
function makeUpdateUserDetailBranch({ updateDataUserDetailBranch, internalServer, redisClient }) {
    return function updateUserDetailBranch(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield updateDataUserDetailBranch(bodyparam);
                    const entityLog = {
                        username: authMe.data.username,
                        moduleId: bodyparam.moduleId,
                        menuId: '004',
                        screenId: 'User Branch Mapping',
                        actionType: 'Update',
                        actionDetail: 'Update User Branch',
                        actionBeUrl: '/credential/user/detail/branch',
                        actionBeMethod: 'POST'
                    };
