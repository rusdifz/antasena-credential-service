...
function makeGetUserDetailRole({ getDataUserDetailRole, internalServer, redisClient }) {
    return function getUserDetailRole(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield getDataUserDetailRole(bodyparam);
                }
                const entityLog = {
                    ...
                    actionType: 'get',
                    actionDetail: 'Show List Data User Role Detail',
                    actionBeUrl: '/credential/user/detail/role',
                    actionBeMethod: 'GET'
                };
