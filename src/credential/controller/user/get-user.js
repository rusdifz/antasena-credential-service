...
function makeGetUser({ getDataUser, internalServer, redisClient }) {
    return function getUser(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (authMe.status == false) {
                    ...
                    posted = yield getDataUser(Object.assign(Object.assign({}, bodyparam), token));
                }
                const entityLog = {
                    ...
                    actionType: 'get',
                    actionDetail: 'Show List Data User All',
                    actionBeUrl: '/credential/user',
                    actionBeMethod: 'GET'
                };
